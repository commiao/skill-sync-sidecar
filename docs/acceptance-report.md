...
## 2026-06-16 OpenClaw P2a Wave-3 Live Allowlist Apply

P2a Wave-3 installed four reviewed report/documentation workflow skills:
...
```text
local_snapshot=/private/tmp/openclaw-admission-p2a-wave3-snapshot-20260616
local_target=/private/tmp/openclaw-admission-p2a-wave3-local-target-20260616
openclaw_snapshot=/tmp/openclaw-admission-p2a-wave3-snapshot-20260616
openclaw_target=/tmp/openclaw-admission-p2a-wave3-validate-20260616-1032/target
plan={"pull_new": 4}
apply=4
scan=4
...
## 2026-06-16 OpenClaw P2a Wave-4 Live Allowlist Apply

P2a Wave-4 installed four reviewed browser-audit/report workflows:
...
```text
local_snapshot=/private/tmp/openclaw-admission-p2a-wave4-snapshot-20260616
local_target=/private/tmp/openclaw-admission-p2a-wave4-local-target-20260616
openclaw_snapshot=/tmp/openclaw-admission-p2a-wave4-snapshot-20260616
openclaw_target=/tmp/openclaw-admission-p2a-wave4-validate-20260616-1037/target
plan={"pull_new": 4}
apply=4
scan=4
risk={"ok": 4, "warning": 0, "error": 0}
...
## 2026-06-16 OpenClaw P2b Wave-5 Live Allowlist Apply

P2b Wave-5 installed two reviewed skill-authoring workflows:
...
```text
local_snapshot=/private/tmp/openclaw-admission-p2b-wave5-snapshot-20260616
local_target=/private/tmp/openclaw-admission-p2b-wave5-local-target-20260616
openclaw_snapshot=/tmp/openclaw-admission-p2b-wave5-snapshot-20260616
openclaw_target=/tmp/openclaw-admission-p2b-wave5-validate-20260616-1300/target
plan={"pull_new": 2}
apply=2
scan=2
risk={"ok": 2, "warning": 0, "error": 0}
...
## 2026-06-16 OpenClaw P2b Wave-6 Live Allowlist Apply

P2b Wave-6 installed four reviewed browser, observability, and performance workflows:
...
```text
local_snapshot=/private/tmp/openclaw-admission-p2b-wave6-snapshot-20260616
local_target=/private/tmp/openclaw-admission-p2b-wave6-local-target-20260616
openclaw_snapshot=/tmp/openclaw-admission-p2b-wave6-snapshot-20260616
openclaw_target=/tmp/openclaw-admission-p2b-wave6-validate-20260616-1312/target
plan={"pull_new": 4}
apply=4
scan=4
risk={"ok": 4, "warning": 0, "error": 0}
...
## 2026-06-16 OpenClaw P2c Wave-8 Live Allowlist Apply

P2c Wave-8 installed the reviewed `qa` workflow as a single-skill batch:
...
```text
local_snapshot=/private/tmp/openclaw-admission-p2c-wave8-snapshot-20260616
local_target=/private/tmp/openclaw-admission-p2c-wave8-local-target-20260616
openclaw_snapshot=/tmp/openclaw-admission-p2c-wave8-snapshot-20260616
openclaw_target=/tmp/openclaw-admission-p2c-wave8-validate-20260616-1328/target
plan={"pull_new": 1}
apply=1
scan=1
risk={"ok": 1, "warning": 0, "error": 0}
...
## 2026-06-16 OpenClaw P2c Wave-9 Live Allowlist Apply

P2c Wave-9 installed two reviewed release workflows:
...
```text
local_snapshot=/private/tmp/openclaw-admission-p2c-wave9-snapshot-20260616
local_target=/private/tmp/openclaw-admission-p2c-wave9-local-target-20260616
openclaw_snapshot=/tmp/openclaw-admission-p2c-wave9-snapshot-20260616
openclaw_target=/tmp/openclaw-admission-p2c-wave9-validate-20260616-1335/target
plan={"pull_new": 2}
apply=2
scan=2
risk={"ok": 2, "warning": 0, "error": 0}
...
## 2026-06-16 OpenClaw P2c Wave-12 Live Allowlist Apply

P2c Wave-12 installed the reviewed setup/upgrade workflows:
...
```text
local_snapshot=/private/tmp/openclaw-admission-p2c-wave12-snapshot-20260616
local_target=/private/tmp/openclaw-admission-p2c-wave12-local-target-20260616
openclaw_snapshot=/tmp/openclaw-admission-p2c-wave12-snapshot-20260616
openclaw_target=/tmp/openclaw-admission-p2c-wave12-validate-20260616-1355/target
plan={"pull_new": 2}
apply=2
scan=2
...
- OpenClaw P2a Wave-3 live allowlist apply for `document-release`, `health`, `landing-report`, and `retro`, with post-apply reconcile at `same_without_base=70,pull_new=22`
