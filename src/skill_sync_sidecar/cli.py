...
def build_parser() -> argparse.ArgumentParser:
    ...
    ops_status.add_argument("--allow-delete", action="store_true", help="Evaluate the sync plan with delete/deprecate review allowed; central files are not physically deleted.")
    ...
    publish_peer_status.add_argument("--allow-delete", action="store_true", help="Evaluate the sync plan with delete/deprecate review allowed; central files are not physically deleted.")
    ...
    dashboard.add_argument("--allow-delete", action="store_true", help="Evaluate the sync plan with delete/deprecate review allowed; central files are not physically deleted.")
    ...
    local_skill_publish.add_argument("--local-root", default="~/.cc-switch/skills", help="Local canonical tool root to save from.")
    ...
    sync_plan.add_argument("--allow-delete", action="store_true", help="Allow one-sided deletes to be planned as restore/deprecate review; central files are not physically deleted.")
    ...
    blocked_report.add_argument("--allow-delete", action="store_true", help="Evaluate blocked items with delete/deprecate review planned.")
    ...
    approved_push = subcommands.add_parser("approved-push", help="Save explicitly approved blocked local push items to the remote.")
    ...
    approved_push.add_argument("--allow-conflict-local-wins", action="store_true", help="Allow selected conflict items to publish the current local version after stale-hash validation.")
    ...
    try:
        if args.dry_run:
            preview = build_approved_push_preview(
                ...
                allow_conflict_local_wins=args.allow_conflict_local_wins,
            )
